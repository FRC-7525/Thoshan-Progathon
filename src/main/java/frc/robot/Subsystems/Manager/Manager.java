...
public class Manager extends Subsystem<ManagerStates>{
    ...
    private Manager() {
        super("Manager", ManagerStates.IDLE);
        // Amp Scorring
        addTrigger(ManagerStates.IDLE, ManagerStates.PASSINGAMP, () -> xboxController.getYButtonPressed());
        addTrigger(ManagerStates.PASSINGAMP, ManagerStates.AMPSCORING, () -> xboxController.getYButtonPressed());
        addTrigger(ManagerStates.AMPSCORING, ManagerStates.IDLE, () -> xboxController.getYButtonPressed());

        // Climbing
        addTrigger(ManagerStates.IDLE, ManagerStates.CLIMBERSOUT, () -> xboxController.getPOV() == 0);
        addTrigger(ManagerStates.CLIMBERSOUT, ManagerStates.CLIMBING, () -> xboxController.getPOV() == 180);

        // Intaking
        addTrigger(ManagerStates.IDLE, ManagerStates.INTAKING, () -> xboxController.getAButtonPressed());
        addTrigger(ManagerStates.INTAKING, ManagerStates.IDLE, () -> xboxController.getAButtonPressed());

        // Shooting
        addTrigger(ManagerStates.IDLE, ManagerStates.LOADINGSHOOTER, () -> xboxController.getXButtonPressed());
        addTrigger(ManagerStates.LOADINGSHOOTER, ManagerStates.SHOOTING, () -> xboxController.getXButtonPressed());
        addTrigger(ManagerStates.SHOOTING, ManagerStates.IDLE, () -> xboxController.getXButtonPressed());
